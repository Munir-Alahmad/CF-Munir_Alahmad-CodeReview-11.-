...
if ($_POST) {
   ...
   ($userpic =="avatar.png")?: unlink("pictuers/$userpic");
...
<head>
   ...
   <title>Delete User</title>
    ...
    <style><?php include "products/css/delete.css"; ?></style>
   <style type= "text/css" >
      fieldset {
           margin: auto;
           margin-top: 100px;
...
<fieldset>
<legend class='h2 mb-3' >Delete request <img class= 'img-thumbnail rounded-circle'  src='pictuers/<?php echo $userpic ?>' alt="<?php echo $first_name ?>"></legend >
